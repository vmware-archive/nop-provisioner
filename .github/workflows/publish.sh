...
echo "Publishing riff nop provisioner"
(cd $root && KO_DOCKER_REPO="gcr.io/projectriff/nop-provisioner" ko publish -t "${version}" -t "${slug}" github.com/projectriff/nop-provisioner/cmd/provisioner)
